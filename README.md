...
Baixe somente o arquivo **[PokeDOG-Modpack-Installer.exe](https://github.com/JpAndreBTA/PokeDOG-Modpack-Installer/releases/download/v0.1.4/PokeDOG-Modpack-Installer.exe)** ou use `mine.ayellol.com`.
...
Versao publica atual: `v0.1.4`. O release publica EXE, Client Guard, manifesto e payload; o Google Drive permanece sincronizado como mirror do payload.
